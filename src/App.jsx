...
function App() {
  const [activeTab, setActiveTab] = useState(() => {
    return localStorage.getItem('gotNextActiveTab') || 'overview'
  })
  const [username, setUsername] = useState('')
  const [password, setPassword] = useState('')

  useEffect(() => {
    localStorage.setItem('gotNextActiveTab', activeTab)
  }, [activeTab])
      ...
      <div className="app-container">
        ...
        <header className="header" style={{ padding: '1rem 0', borderBottom: '1px solid var(--panel-border)', marginBottom: '3rem' }}>
          ...
          <div className="header-actions">
            <button
              className={`sign-in-button ${activeTab === 'sign-in' ? 'active' : ''}`}
              ...
              <div className="sign-in-page">
                <div className="sign-in-card">
                  <div className="sign-in-card-header">
                    <svg viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="var(--neon-cyan)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                      <circle cx="12" cy="7" r="4"></circle>
                    </svg>
                    <h2 className="sign-in-page-title">Sign In</h2>
                  </div>
                  ...
                  <button className="sign-in-submit" id="sign-in-submit">
                    Sign In
                  </button>
                  <div className="sign-in-divider">
                    <span>or</span>
                  </div>
                  <button className="create-account-button" id="create-account">
                    Create New Account
                  </button>
                  <div className="sign-in-divider">
                  ...
                  <div className="oauth-buttons">
                    <button className="oauth-button" id="google-sign-in" aria-label="Sign in with Google">
                    ...
                    <button className="oauth-button" id="microsoft-sign-in" aria-label="Sign in with Microsoft">
